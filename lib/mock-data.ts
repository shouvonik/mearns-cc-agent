...
export const MOCK_GAMES: PlayHQGame[] = [
  ...
  // ── 2026 Upcoming Friendlies ─────────────────────────────────────────────
  {
    id: "fri-2026-1",
    status: "upcoming",
    round: null,
    startTime: "2026-04-18T12:00:00Z",
    homeTeam: { id: "mearns", name: "Mearns Cricket Club" },
    awayTeam: { id: "east-kilbride", name: "East Kilbride CC" },
    venue: { name: "Bellahouston Park", address: "Glasgow" },
    grade: { id: "fri-prem2", name: "Friendly (Prem 2) — 50 overs" },
    result: null,
  ...
  },
  {
    ...
    homeTeam: { id: "ferguslie", name: "Ferguslie CC" },
    awayTeam: { id: "mearns", name: "Mearns Cricket Club" },
    venue: { name: "Ferguslie CC Ground", address: "Ferguslie, Paisley" },
    grade: { id: "fri-champ2", name: "Friendly (Champ 2) — 50 overs" },
    result: null,
    resultDescription: null,
  },
  {
    ...
    homeTeam: { id: "west-of-scotland", name: "West of Scotland CC" },
    awayTeam: { id: "mearns", name: "Mearns Cricket Club" },
    venue: { name: "Partick Cricket Ground", address: "Partick, Glasgow" },
    grade: { id: "fri-champ2", name: "Friendly (Champ 2) — 50 overs" },
    result: null,
    resultDescription: null,
  },
  {
    ...
    homeTeam: { id: "mearns", name: "Mearns Cricket Club" },
    awayTeam: { id: "east-kilbride", name: "East Kilbride CC" },
    venue: { name: "New Williamfield 2", address: "Scotland" },
    grade: { id: "fri-prem2", name: "Friendly (Prem 2) — 50 overs" },
    result: null,
    resultDescription: null,
  },
  {
    ...
    startTime: "2026-04-26T12:00:00Z",
    homeTeam: { id: "mearns", name: "Mearns Cricket Club" },
    awayTeam: { id: "milngavie", name: "Milngavie CC" },
    venue: { name: "Bellahouston Park", address: "Glasgow" },
    grade: { id: "fri-champ4", name: "Friendly (Champ 4) — 50 overs" },
    result: null,
    resultDescription: null,
  },
